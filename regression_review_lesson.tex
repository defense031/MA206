...
\textbf{Overview:} You will work through \emph{six} regression problems, each divided into three stages:
\begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{E}qual variance: Residuals have constant variance (homoscedasticity)
\end{itemize}
...
\vspace{1cm}
\noindent
\textbf{Your clue to Problem 2:} If your residual is negative and between $-10$ and $-20$, proceed to Problem 2!
...
\vspace{3cm}
\noindent
\textbf{Your clue to Problem 3:} If you rejected $H_0$, you're ready for Problem 3!
...
\vspace{3cm}
\noindent
\textbf{Your clue to Problem 4:} If you said that $R^2$ always increases but Adjusted $R^2$ penalizes for added predictors, move to Problem 4!
...
\vspace{2cm}
\noindent
\textbf{Your clue to Problem 5:} If your predicted price is between \$250K and \$350K, head to Problem 5!

\newpage

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% PROBLEM 5 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{center}
  {\Large \textbf{Problem 5: Categorical Variables \& Dummy Coding}}
\end{center}
...
\vspace{3cm}
\noindent
\textbf{Your clue to Problem 6:} The difference in predicted salaries between remote and in-office workers (same experience) should be \$7,000. If you got this, proceed to the final problem!

\newpage

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% PROBLEM 6 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{center}
  {\Large \textbf{Problem 6: Interaction Effects (Putting It All Together!)}}
\end{center}

\vspace{1cm}
\noindent
\textbf{Stage 1: Recognizing Interactions}
...
\noindent
\textbf{Stage 2: Understanding the Interaction Term}
...
\noindent
\textbf{Stage 3: Interpretation and Hypothesis Testing}

\textbf{Question A:} Based on your equations from Stage 2, what is the slope of Hours for each group? Does the effect of study hours differ between groups?
...
\subsection*{Problem 5: Categorical Variables \& Dummy Coding}
\begin{itemize}
...
\subsection*{Problem 6: Interaction Effects}
\begin{itemize}
    \item \textbf{Stage 1:} In Model 1, the slope is 2.5 for both groups (no interaction—parallel lines).
    \item \textbf{Stage 2A:} $\widehat{\text{Score}} = 55 + 1.8 \times \text{Hours}$ (no tutoring)
    \item \textbf{Stage 2B:} $\widehat{\text{Score}} = 55 + 1.8 \times \text{Hours} + 12 + 1.2 \times \text{Hours} = 67 + 3.0 \times \text{Hours}$ (with tutoring)
    \item \textbf{Stage 3A:} Slope = 1.8 (no tutoring), Slope = 3.0 (with tutoring). Yes, the effect differs!
    \item \textbf{Stage 3B:} $H_0: \beta_3 = 0$ (no interaction); $H_a: \beta_3 \neq 0$ (interaction exists)
\end{itemize}
