...
\textbf{Overview:} You will work through \emph{five} regression problems. Most problems have three stages, but the final problem has four stages:
\begin{itemize}
...
\begin{enumerate}
    \item Complete all stages of each problem.
    \item Check your answer with CPT Semmel after each stage to receive your next clue.
    \item Add up your points at the end to see your total out of \textbf{1600 points}!
\end{enumerate}
...
\noindent
\textbf{Stage 4: Understanding Interactions}

Recall the interaction lesson from Part 1. A researcher studying student test scores fits a model with an interaction term:
...
\vspace{0.5cm}
\noindent
\textbf{Question A:} Write the simplified fitted equation for students who DID NOT attend tutoring (Tutoring = 0).

\vspace{2cm}

\noindent
\textbf{Question B:} Write the simplified fitted equation for students who DID attend tutoring (Tutoring = 1).

\vspace{2cm}

\noindent
\textbf{Question C:} Based on your two equations, what is the slope of Hours for each group? Does the effect of study hours differ between the two groups?
...
\vspace{1cm}
\noindent
\textbf{Total Score: \underline{\hspace{2cm}} / 1600}
...
\begin{itemize}
    ...
    \item \textbf{Stage 4A:} $\widehat{\text{Score}} = 55 + 1.8 \times \text{Hours}$ (no tutoring)
    \item \textbf{Stage 4B:} $\widehat{\text{Score}} = 55 + 1.8 \times \text{Hours} + 12 + 1.2 \times \text{Hours} = 67 + 3.0 \times \text{Hours}$ (with tutoring)
    \item \textbf{Stage 4C:} Slope = 1.8 (no tutoring), Slope = 3.0 (with tutoring). Yes, the effect of study hours differs between groups!
\end{itemize}
